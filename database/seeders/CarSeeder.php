        ...
        $cars = [
            [
                ...
                'images' => json_encode([
                    ...
                    'images/camry/2021-toyota-camry-hybrid-xle-138-1603151483.jpg',
                ]),
                'status' => 'available',
                'disponible' => true,
            ],
            [
                ...
                'fuel_type' => 'Gasoline',
                'air_conditioner' => true,
                'image' => 'images/civic/honda-civic.jpg',
                'status' => 'available',
                'disponible' => true,
            ],
            [
                ...
                'fuel_type' => 'Gasoline',
                'air_conditioner' => true,
                'image' => 'images/mustang/ford-mustang.jpg',
                'status' => 'available',
                'disponible' => true,
            ],
            [
                ...
                'year' => 2022,
                'category' => 'SUV',
                'description' => 'Luxurious SUV with powerful performance and premium features.',
            ...
            [
                ...
                'fuel_type' => 'Electric',
                'air_conditioner' => true,
                'image' => 'images/model3/tesla-model3.jpg',
                'status' => 'available',
                'disponible' => true,
            ],
            [
                ...
                'image' => 'images/wrangler/jeep-wrangler.jpg',
                'status' => 'available',
                'disponible' => true,
            ],
        ];
