...
@section('content')
    ...
    <body>
            ...
            <div class="row">
                ...
                <div class="col-md-6 d-flex align-items-center">
                    <div class="text-center text-md-start p-5">
                        ...
                        <p class="lead text-muted" style="max-width: 500px;">Sed volutpat sed nunc vel porttitor. Integer
                            euismod, nisi vel consectetur interdum, nisl nisi aliquet nunc, eget facilisis ligula nisi eget
                            ligula.</p>
                        <form method="post" action="{{ route('search.cars') }}" class="mt-4">
                            @csrf

                            <div class="mb-3">
                                <input type="date" class="p-2 col-12 rounded-lg shadow-md" required
                                    name="date_de_location" min="{{ date('Y-m-d') }}" value="{{ date('Y-m-d') }}"
                                    id="pickupDate">
                            </div>
                            <div class="mb-3">
                                <input required name="date_de_retour" type="date" class="p-2 col-12 rounded-lg shadow-md"
                                    min="{{ date('Y-m-d', strtotime('+1 day')) }}"
                                    value="{{ date('Y-m-d', strtotime('+1 day')) }}" id="returnDate">
                            </div>
                            <button type="submit" class="btn btn-primary"
                                style="background-color: #FF6B00; border-color: #FF6B00;">Search Cars</button>
                        </form>
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                // Set the values and min attributes
                                ...
                                document.getElementById('pickupDate').addEventListener('change', function() {
                                    ...
                                    // Set min attribute of return date to be at least the pickup date
                    ...
                    <div id="carCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item">
                                <img src="{{ asset('images/slideshow/interior-wall-mockup-with-sofa-cabinet-living-room-with-empty-white-wall-background-3d-rendering.jpg') }}"
                                    class="d-block w-100" alt="Car 2">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('images/slideshow/wood-sideboard-living-room-interior-with-copy-space.jpg') }}"
        ...
        <section class="main-section py-20 bg-gray-50 text-center">
            ...
            <p class="text-gray-700 mb-12">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor
                ...
                <div class="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-16">
                    ...
                    <div class="flex flex-col gap-6 w-full md:w-1/2">
                        ...
                        <div class="info-box bg-gray-100 p-6 rounded-lg shadow-md">
                            ...
                            <p>Monday - Friday: <strong>{{ $agence->temp_debut }}</strong> AM -
                                <strong>{{ $agence->temp_fin }}</strong> PM</p>
                            <p>Week End: Closed</p>
                        </div>
                            ...
                            <div class="col">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Sed do eiusmod tempor incididunt ut labore et dolore magna
                                            aliqua.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Ut enim ad minim veniam, quis nostrud exercitation ullamco
                                            laboris.</p>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="contact py-20 bg-white text-center px-10 mx-10">
            <div class="flex flex-col md:flex-row justify-center items-center gap-8">
                ...
                <!-- Right: Contact Form -->
                <form class="contact-form w-full md:w-1/2 bg-gray-100 p-8 rounded-lg shadow-md"
                    action="{{ route('reviews.store') }}" method="post">
                    @csrf
                    <div class="input-group mb-4">
                        <input type="text" name="first_name" placeholder="First Name" required
                            class="w-full p-2 rounded-lg shadow-md">
                    </div>
                    <div class="input-group mb-4">
                    ...
                    <button type="submit"
                        class="w-full p-2 bg-green-500 text-white font-bold rounded-lg shadow-md">Submit</button>
                </form>
